...
class EditNovelViewController: UIViewController {
    ...
    @objc private func saveNovel() {
        ...
        let updatedNovel = Novel(title: title, content: content, prompt: novel?.prompt ?? "", wordCount: wordCount, keyword: keyword)

        NovelStorage.shared.updateNovel(updatedNovel)
